...
class _OutfitRatingState extends State<OutfitRating> {
  ...
  // Outfit log ID passed as argument (optional)
  String? _outfitLogId;

  final List<String> _occasions = [
    'Casual', 'Work', 'Formal', 'Athletic',
    'Social Event', 'Date Night', 'Travel',
  ];
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (args is Map<String, dynamic>) {
        setState(() {
          _outfitLogId = args['outfitLogId'] as String?;
          if (args['occasion'] != null) {
            _selectedOccasion = args['occasion'] as String;
          }
        });
      }
    });
  ...
  Future<void> _saveRating() async {
    ...
    try {
      ...
      if (_outfitLogId != null) {
        ...
        await _outfitLogService.updateOutfitLog(
          outfitId: _outfitLogId!,
          rating: _overallRating,
          occasion: _selectedOccasion,
          notes: notes,
        );
      } else {
        // Create a standalone rating log for today
        final userId = SupabaseService.instance.client.auth.currentUser?.id;
        if (userId != null) {
          await _outfitLogService.createOutfitLog(
            occasion: _selectedOccasion,
            itemIds: [],
  ...
  Widget _buildRatingRow(ThemeData theme, String label, int rating,
        ...
        child: Row(
          ...
          children: [
            ...
            Switch(
              ...
              onChanged: (value) => setState(() => _wouldWearAgain = value),
