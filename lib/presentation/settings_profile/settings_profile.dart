...
class _SettingsProfileState extends State<SettingsProfile> {
  ...
  Future<void> _loadSavedSettings() async {
    ...
    if (mounted) {
      setState(() {
        _selectedLanguage = savedLocale?.languageCode ?? 'en';
            ...
            SettingsSectionWidget(
              ...
              children: [
                SettingsTileWidget(
                  ...
                  subtitle: _getThemeLabel(_selectedTheme, localizations),
  ...
  void _applyThemeMode(String themeMode) async {
    ...
    await LocaleManager.saveThemeMode(themeMode);

    // Update local state to reflect the change immediately
    setState(() => _selectedTheme = themeMode);
